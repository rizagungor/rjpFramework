	...
	<div id="kk<?php echo $key['kat_id']; ?>" class="tab-pane fade <?php if($say==1){ echo "in active";} ?>">
        <p>
			...
			<?php 
				...
				<a href="yenikodSil.php?d=dd&id=id" style="cursor: pointer; float: right;" title="Delete this code"><span class="	glyphicon glyphicon-trash"></span> &nbsp;</a>
				<a href="yenikodDuzenle.php?d=dd&id=id" style="cursor: pointer; float: right; padding-right: 25px;" title="Edit this code"><span class="glyphicon glyphicon-edit"></span> &nbsp;</a>	
			</div>
		<?php } ?>
		</p>
    </div> 
